...
func init() {
	m.Register(func(app core.App) error {
		jsonData := `[
			...
			{
				"createRule": "@request.auth.id ?~ deck.roomId.user.id",
				"deleteRule": "@request.auth.id ?~ deck.roomId.user.id",
				"fields": [
					{
						"autogeneratePattern": "[a-z0-9]{15}",
						"hidden": false,
				...
				"id": "pbc_3481593366",
				"indexes": [],
				"listRule": "@request.auth.id ?~ deck.roomId.user.id",
				"name": "cards",
				"system": false,
				"type": "base",
				"updateRule": "@request.auth.id ?~ deck.roomId.user.id",
				"viewRule": "@request.auth.id ?~ deck.roomId.user.id"
			},
			{
				"createRule": "@request.auth.id ?~ roomId.user.id",
				"deleteRule": "@request.auth.id ?~ roomId.user.id",
				"fields": [
					{
						"autogeneratePattern": "[a-z0-9]{15}",
						"hidden": false,
				...
				"id": "pbc_1757051097",
				"indexes": [],
				"listRule": "@request.auth.id ?~ roomId.user.id",
				"name": "decks",
				"system": false,
				"type": "base",
				"updateRule": "@request.auth.id ?~ roomId.user.id",
				"viewRule": "@request.auth.id ?~ roomId.user.id"
			},
			{
				"createRule": null,
				"deleteRule": null,
